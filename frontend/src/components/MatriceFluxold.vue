          ...
          <tr v-for="(source, i) in metadata.sources" :key="i">
            ...
            <td v-for="(dest, j) in metadata.destinations" :key="j" class="p-1">
              <div :class="getCellClass(i, j)"
                class="relative min-w-[60px] h-14 rounded-xl flex flex-col items-center justify-center
...
<script setup>
const props = defineProps({ flux: Array, config: Object, metadata: Object, caseActive: Array, cycle: Array })
