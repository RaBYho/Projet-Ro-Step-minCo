...
const exemples = [
  ...
  { 
    label: '3×3 Classique',
    couts: [[4,8,8],[16,24,16],[8,16,24]],
    offres: [76,82,77],
    demandes: [72,102,61] 
  },
  {
    label: '3×4 Grand',
    couts: [[2,3,1,5],[7,3,4,2],[6,1,5,4]],
    offres: [120,80,80],  
    ...
    demandes: [60,40] },
  {
    ...
    couts: [[2,3,5,7],[1,4,6,2],[3,2,4,5],[4,5,2,3],[6,1,3,4]],
    offres: [30,40,50,20,60],
    demandes: [50,60,40,50]
  },
  {
    label: 'TD n°7',
    couts: [[9,12,9,6,9,10],[7,3,7,7,5,5],[6,5,9,11,3,11],[6,8,11,2,2,10]],
    offres: [50,60,20,90],
    demandes: [40,30,70,20,40,20]
  },
  {
    label: 'TD n°8',
    couts: [[21,11,84,49,13],[27,52,43,29,42],[11,47,14,80,93],[52,14,76,74,54]],
    offres: [896,782,943,928],
    demandes: [800,439,50,790,1470]
  },
  {
    label: 'TD n°9',
    couts: [[45,60,15,30,45,40],[35,15,10,35,25,5],[20,15,45,55,10,55],[30,40,55,10,10,50]],
    offres: [25,30,10,45],
